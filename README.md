...
A demo of custom popup menu, Developed using Flutter.
...
git clone https://github.com/Mobile-Apps-Academy/CustomPopupMenuFlutter.git

```
### Usage

1. How to add the popup menu
